...
<div class="container">
    ...
    <!-- <a href="http://daum.net" class="btn btn-primary" onclick="return true">다음으로 이동</a> -->

    <form method="post" action="requestTestPro2.jsp" onsubmit="return checkForms(this)">
        <div class="row mb-3">
            <label for="num" class="col-sm-2 col-form-label">학번</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="num" name="num" placeholder="20211234" required>
            </div>
        </div>
        <div class="row mb-3">
