...
<%  request.setCharacterEncoding("utf-8");
    ...
    String sql2= "select * from t_member_add where id= ?";
    ...
    <div class="row">
      ...
      <div class="col-9">
        <form method="post" action="userUpdatePro.jsp">
          ...
          <div class="mb-3">
            <input type="submit" class="btn btn-primary" onclick="return userUpdate()" value="변경">
            <a href="userDeleteForm.jsp?id=<%=id%>" class="btn btn-danger">회원탈퇴</a>
            <script>
              function userUpdate(){
                  if (document.getElementById("passwd").value!=''){
                      if(confirm("아이디의 정보를 변경하시겠습니까?")){
                          return true;
                      }else {
                          alert("취소하셨습니다");
                          return false;
