...
<%
    ...
    if (count > 0) {
        articleList = dbPro.getArticles(startRow, pageSize, id);
    }
            ...
            if (count > 0) {
                ...
                if (startPage > 10) { %>
                    <li class="page-item disabled">
                        <a href="userBoardForm.jsp?pageNum=<%= startPage - 10 %>" class="page-link">&laquo;</a>
                    </li>
        <%      }
                
                for (int i = startPage ; i <= endPage ; i++) {  %>
                    <li class="page-item active">
                        <a class="page-link" href="userBoardForm.jsp?pageNum=<%= i %>"><%= i %></a>
                    </li>
        <%      }
                
                if (endPage < pageCount) {  %>
                    <li class="page-item">
                        <a href="userBoardForm.jsp?pageNum=<%= startPage + 10 %>" class="page-link" href="#">&raquo;</a>
                    </li>
        <%
                }
            }
